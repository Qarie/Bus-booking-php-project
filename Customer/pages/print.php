...
<head>
  ...
  <style>
    ...
    .wig table tr td:nth-child(2) {
      text-align: right;
    }

    .wig table tr.top table td {
      padding-bottom: 20px;
    }

    .wig table tr.top table td.title {
      font-size: 45px;
      line-height: 45px;
      color: #333;
    }

    .wig table tr.information table td {
      padding-bottom: 40px;
    }

    .wig table tr.heading td {
      background: #eee;
      border-bottom: 1px solid #ddd;
      font-weight: bold;
    }

    .wig table tr.details td {
      padding-bottom: 20px;
    }

    .wig table tr.item td {
      border-bottom: 1px solid #eee;
    }

    .wig table tr.item.last td {
      border-bottom: none;
    }

    .wig table tr.total td:nth-child(2) {
