...
include'config.php';
//inserting into db//
$qr="select * from employees where role='Route Manager'";
...
//submiting into database
  ...
  //check wheteher it has submitted//
  if (is_array($row)) {
    // code...
  ...
  if (isset($_SESSION['username'])) {
    ...
    header("location:dashboard.php");
  	...
  	header("Location: auth-login-basic.php?error=invalid username or password");
		exit();
