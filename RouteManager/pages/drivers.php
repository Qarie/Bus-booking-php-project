      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <?php 
              ...
              ?>
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span><?php echo $execute['name'] ;?></h4>
            ...
            <div class="card">
              ...
              <!-- <div class="card-tools" style="padding-top: 30px; padding-left: 20px;">
                <a href="add_drivers.php"><button type="button" class="btn btn-sm btn-primary"><span style="color: #fff;"><i
                        class="fas fa-plus"></i> Add Driver</span>
                  </button> </a>
              </div> -->
              ...
              <div class="card-body mt-2 " >
                <table id="example1" class="table ">
                  ...
                  <?php $query=mysqli_query($link,"select * from bookings where route='$route'");
