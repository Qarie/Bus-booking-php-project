              ...
              <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                  <div class="row row-bordered g-0">
                    <div class="col-md-8">
                      <h5 class="card-header m-0 me-2 pb-3"><i class="fa fa-book" aria-hidden="true"></i> Bookings</h5>
                  ...
                  <div class="col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <span class="fw-semibold d-block mb-1"><i class="fa fa-user" aria-hidden="true"></i>Route Managers</span>
                        <h3 class="card-title mb-2"></h3>
