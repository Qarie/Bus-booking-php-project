...
//form validations
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (empty($_POST["station"])) {
        ...
        //   $stationErr = "Only letters and white space allowed";
        // }
      }
      ...
      if (empty($_POST["route"])) {
        ...
        // check if route number is well-formed
        // if (!proute_match("/{67}/",$route)) {
        //   $routeErr = "Invalid route number";
   ...
   if(isset($_POST['submit'])) {  
    if($nameErr == "" && $stationErr == "" && $routeErr == ""  ) {
      $sql="INSERT INTO routes (name,stations,route_manager) Values('$name','$station','$route')";
      $sql_query=mysqli_query($link,$sql);
      if($sql_query==TRUE){
        header("Location: add_route.php?success=Route successfully added");
	      exit();
      }else{
        header("Location: add_route.php?error=unknown error occurred");
		    exit();
      }
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Route</h4><hr><br>
              ...
              <?php } ?>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="station"/><br>
                            <span class="error">* <?php echo $stationErr;?></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Route Manager</label>
                          <div class="col-sm-9">
                          
                            <select name="route" id="" class="form-control">
                            <option >--select--</option>
                            <?php $query=mysqli_query($link,"select * from employees where role='Route Manager' ");
