    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Buses</h4>
            ...
            <div class="card">
              ...
              <div class="card-tools" style="padding-top: 30px; padding-left: 20px;">
                <a href="add_buses.php"><button type="button" class="btn btn-sm btn-primary"><span style="color: #fff;"><i
                        class="fas fa-plus"></i> Add Bus</span>
                  </button> </a>
              </div>
