    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Managers</h4>
            ...
            <div class="card">
              ...
              <div class="card-tools" style="padding-top: 30px; padding-left: 20px;">
                <a href="add_route_manager.php"><button type="button" class="btn btn-sm btn-primary"><span style="color: #fff;"><i
                        class="fas fa-plus"></i> Add Manager</span>
                  </button> </a>
              </div>
              <div class="card-body mt-2 " >
                <table id="example1" class="table ">
                  ...
                  <?php $query=mysqli_query($link,"select * from managers");
