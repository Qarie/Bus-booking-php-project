...
//form validations
   ...
   $nameErr = $usernameErr = $dobErr = $sexErr = $phoneErr = $emailErr = $roleErr = $passwordErr = $companyErr = "";
   $name = $username = $dob = $sex = $phone = $email = $role = $password = $company = "";
   ...
   if(isset($_POST['submit'])) {  
    if($nameErr == "" && $usernameErr == "" && $dobErr == "" && $sexErr == "" && $phoneErr == "" && $emailErr == "" && $roleErr == "" && $passwordErr == "") {
      $sql="INSERT INTO managers (name,username,dob,gender,phone,email,role,password,company) Values('$name','$username','$dob','$sex','$phone','$email','$role','$password','$company')";
      $sql_query=mysqli_query($link,$sql);
      if($sql_query==TRUE){
        header("Location: add_route_manager.php?success=Manager has been added successfully");
	      exit();
      }else{
        header("Location: add_route_manager.php?error=unknown error occurred");
		    exit();
      }
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Manager</h4><hr><br>
