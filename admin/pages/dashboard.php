        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="routem.php" class="menu-link">
              <i class=""></i>
              <div data-i18n="Tables"><i class="fa fa-user" aria-hidden="true"></i></> Managers</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="drivers.php" class="menu-link">
              <i class=""></i>
              <div data-i18n="Tables"><i class="fa fa-user" aria-hidden="true"></i></> Drivers</div>
            </a>
          </li>
          <li class="menu-item">
          ...
          <li class="menu-item">
            <a href="buses.php" class="menu-link">
              <i class=""></i>
              <div data-i18n="Tables"><i class="fa fa-bus" aria-hidden="true"></i></> Buses</div>
            </a>
          </li>
          <!-- <li class="menu-item">
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          ...
                          <?php
										...
										?>
                    <p style="font-weight: 900; "><?php echo $total; ?></p>
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          ...
                          <?php
										...
										?>
                    <p style="font-weight: 900; "><?php echo $total; ?></p><i class="fa fa-user"></i>
              ...
              <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                  <div class="row row-bordered g-0">
                    <div class="col-md-8">
                      <!-- <h5 class="card-header m-0 me-2 pb-3">Bus Companies</h5> -->
                    ...
                    <p style="font-weight: 900; "><?php echo $total; ?></p>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                              <a class="dropdown-item" href="bookings.php">View More</a>
                              <a class="dropdown-item" href="javascript:void(0);">Delete</a>
                            </div>
                          </div>
                        </div>
                        <span class="d-block mb-1"><i class="fa fa-book" aria-hidden="true"></i></> Bookings</span>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                          <?php
										$querry=mysqli_query($link, "select * from managers");
										$total=mysqli_num_rows($querry);
                    ...
                    <p style="font-weight: 900; "><?php echo $total; ?></p>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="cardOpt1">
                              <a class="dropdown-item" href="routem.php">View More</a>
                              <!-- <a class="dropdown-item" href="javascript:void(0);">Delete</a> -->
                            </div>
                          </div>
                        </div>
                        <span class="fw-semibold d-block mb-1"><i class="fa fa-user" aria-hidden="true"></i></> Managers</span>
                        <h3 class="card-title mb-2"></h3>
