...
//form validations
   ...
   $nameErr = $licenceErr = $ownerErr = $locationErr = $addressErr =  "";
   $name = $licence = $owner = $location = $address =  "";
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (empty($_POST["location"])) {
        ...
        // if (!preg_match("/^{67}/",$location)) {
        //   $locationErr = "Invalid reg number";
      ...
      if (empty($_POST["address"])) {
        ...
        // check if reg number is well-formed
        // if (!preg_match("/^{67}/",$address)) {
        //   $addressErr = "Invalid reg number";
   ...
   if(isset($_POST['submit'])) {  
    if($nameErr == "" && $licenceErr == "" && $ownerErr == "" && $locationErr == "" && $addressErr == "" ) {
      $sql="INSERT INTO company (name,licence,owner,location,address) Values('$name','$licence','$owner','$location','$address')";
      $sql_query=mysqli_query($link,$sql);
      if($sql_query==TRUE){
        header("Location: add_company.php?success=Bus company successfully added");
	      exit();
      }else{
        header("Location: add_company.php?error=unknown error occurred");
		    exit();
      }
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Bus Company</h4><hr><br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="licence"/><span class="error">* <?php echo $licenceErr;?></span><br>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" name="owner"/><span class="error">* <?php echo $ownerErr;?></span><br>
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="location"/><span class="error">* <?php echo $locationErr;?></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea rows="2" cols="2" class="form-control" name="address" ></textarea><span class="error">* <?php echo $addressErr;?></span><br>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
